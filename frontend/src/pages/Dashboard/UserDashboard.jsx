    ...
    <div className="pl-6 pr-10 py-8 w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="space-y-3">
                {overdueTasks.map((task, i) => (
                  <div key={task} className="flex items-center justify-between">
                    <span className="text-[#A90836] font-semibold text-sm">{task}</span>
                    <span className="text-[#C70036] text-xs">{overdueProjects[i]}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-amber-50 border border-amber-100 rounded-2xl p-5">
              ...
              <div className="space-y-3">
                {activeBlockers.map((blocker, i) => (
                  <div key={blocker}>
                    <p className="text-amber-900 font-semibold text-sm leading-normal">{blocker}</p>
            ...
            <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-5">
              ...
              <p className="text-indigo-700 font-normal text-sm leading-normal">
                You haven't submitted today's scrum update yet.
              </p>
              <button className="text-indigo-700 font-bold text-sm mt-3 hover:underline cursor-pointer flex items-center">
                Submit Now →
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
              <h3 className="font-bold text-slate-900 text-lg mb-4">In Progress</h3>
            ...
            {/* To Do quick list */}
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
              <h3 className="font-bold text-slate-900 text-lg mb-4">To Do</h3>
              <ul className="space-y-4">
            ...
            {/* My Productivity */}
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
              <h3 className="font-bold text-slate-900 text-lg mb-4">My Productivity</h3>
