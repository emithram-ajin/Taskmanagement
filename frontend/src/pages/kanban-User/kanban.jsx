...
import { Flag, CalendarDays, User, ChevronDown } from "lucide-react";
...
function TaskCard({ task, onDragStart, style }) {
    ...
    return (
        <div
            ...
            style={style}
            className="tb-card-in bg-white  rounded-xl border border-slate-200 p-4 cursor-grab active:cursor-grabbing hover:shadow-md hover:border-indigo-200 hover:-translate-y-0.5 transition-all duration-200 select-none"
        >
            {/* Title row */}
...
export default function TaskBoard() {
    ...
    return (
        <div className="px-8 py-6 flex flex-col">
            ...
            {/* Kanban Columns */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pb-6 items-stretch">
