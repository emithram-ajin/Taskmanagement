      ...
      <form className="space-y-4" onSubmit={e => { e.preventDefault(); onClose(); }}>
        ...
        <div>
          ...
          <div className="border border-slate-200 rounded-lg p-3 space-y-2 max-h-40 overflow-y-auto">
            {['Frontend Team', 'Backend Team', 'Marketing Team'].map(team => (
              <label key={team} className="flex items-center space-x-3 text-sm text-slate-700 cursor-pointer hover:bg-slate-50 p-1 rounded transition-colors">
