...
// A modern custom dropdown to replace the plain native <select>. Used in the
// (currently disabled) edit modal.
function ModernSelect({ value, options, onChange, placeholder = "Select...", allowClear = false }) {
    ...
    return (
        <div ref={ref} className="relative">
            ...
            {open && (
                <div className="absolute z-20 mt-1.5 w-full bg-white border border-gray-200 rounded-lg shadow-lg py-1 max-h-56 overflow-y-auto">
                    {allowClear && (
                        <button
                            type="button"
                            onClick={() => {
                            ...
                            className="w-full flex items-center justify-between px-3 py-2 text-sm text-left text-gray-400 hover:bg-gray-50 border-b border-gray-100"
                        >
                            {placeholder}
                        </button>
                    )}
...
// plain YYYY-MM-DD strings from <input type="date">. Empty from/to means
                ...
                <table className="w-full text-left border-collapse min-w-[820px]">
                    <thead>
                        <tr className="border-b border-gray-200 bg-white">
                            ...
                            <th className="px-6 py-4 text-[15px] font-semibold text-gray-800">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        {loading && (
                        ...
                        {!loading && error && (
                            <tr>
                                <td colSpan={8} className="px-6 py-10 text-center text-rose-500 text-sm">
                                    {error}
                                </td>
                            </tr>
                        )}
